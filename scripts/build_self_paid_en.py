...
PAGE_STYLES = """
    ...
    .med-table.cost th:nth-child(2), .med-table.cost td:nth-child(2) { width: 1%; min-width: 150px; max-width: 200px; white-space: normal; word-break: break-word; font-size: 11px; }
    ...
    #priority .med-table.cost th:nth-child(4), #priority .med-table.cost td:nth-child(4) { width: 1%; min-width: 150px; max-width: 200px; white-space: normal; word-break: break-word; font-size: 11px; }
